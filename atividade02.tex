...
void EditorGUI::onGUI(ImGuiContext* context)
{
  ...
  ImGui::Begin("Options", nullptr, ImVec2(128,128),0, ImGuiWindowFlags_ChildWindowAutoFitX | ImGuiWindowFlags_ChildWindowAutoFitY);
  ...
  ImGui::Begin("Histogram", nullptr, ImGuiWindowFlags_ChildWindowAutoFitX | ImGuiWindowFlags_ChildWindowAutoFitY );
  ImGui::PlotHistogram("", histogramData, 256, 0, "Color", 0.f, maxValue, ImVec2(0,80));
  ImGui::End();
}
\end{lstlisting}
